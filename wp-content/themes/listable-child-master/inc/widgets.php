	...
	public function widget( $args, $instance ) {
		...
		<div class="listing-map-content">
			...
			<?php if ( ! empty( $get_directions_link ) ) { ?>
				<a href="<?php echo $get_directions_link; ?> target="_blank"><div class="title-widgets"><i class="_mi _before dashicons dashicons-flag" aria-hidden="true"></i>&nbsp;<b>Get</b> directions</div></a>
			<?php } ?>
...
class Listing_Sidebar_Hours_Widget extends WP_Widget {
	...
	public function widget( $args, $instance ) {
		...
		if ( ! empty ( $hours ) ) :
			...
			echo $args['before_widget']; ?>
			<div class="title-widgets"><i class="_mi _before dashicons dashicons-clock" aria-hidden="true"></i>&nbsp;<b>Opening</b> times</div>
			<br /><br />
	...
	public function widget( $args, $instance ) {
		...
		if ( ! empty( $photos ) ) :
			...
			<header class="listing-gallery__header">
				<span class="listing-gallery__title"><div class="title-widgets"><i class="_mi _before dashicons dashicons-gallery" aria-hidden="true"></i>&nbsp;<b>Photo</b> gallery</div>
</span>
...
class Listing_Sidebar_Claim_Listing_Widget extends WP_Widget {
	...
	public function widget( $args, $instance ) {
		...
		$is_claimed = get_post_meta( $post->ID, '_claimed', true );
