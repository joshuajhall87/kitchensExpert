	...
	<article class="<?php echo esc_attr( $listing_classes ); ?>" itemscope itemtype="http://schema.org/LocalBusiness"
		...
		<a href="<?php the_job_permalink(); ?>">
			<aside class="card__image"
			       style="background-image: url(<?php echo listable_get_post_image_src( $post->ID, 'listable-card-image' ) ? listable_get_post_image_src( $post->ID, 'listable-card-image' ) : apply_filters( 'listing_card_placeholer', ''); ?>);">
