...
class WPJMS_Settings{
	...
	public function admin_notice_install_pages() {
		...
		<div class="notice notice-info wpjms-install-pages-notice">
			...
			<p>
				<a class='button-primary' href='<?php echo esc_url( add_query_arg( array( 'install_pages' => 1, 'nonce' => wp_create_nonce( 'wpjms-install_pages' ) ) ) ); ?>'><?php _e( 'Install Content', 'wp-job-manager-stats' ); ?></a>

				<a class='skip button-secondary' href='<?php echo esc_url( add_query_arg( array( 'install_pages' => 0, 'nonce' => wp_create_nonce( 'wpjms-install_pages' ) ) ) ); ?>'><?php _e( 'Skip Installation', 'wp-job-manager-stats' ); ?></a>
			</p>
