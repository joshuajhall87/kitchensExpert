...
class WPJMS_Dashboard{
	...
	public function job_stats(){
		...
		echo wpautop( '<a class="button back-to-stat-dashboard" href="' . esc_url( get_permalink() ) . '">' . __( 'View All Listing Stats' ) . '</a>' );
	}
	...
	public function job_stats_chart_ajax(){
		...
		if( ! $post || 'job_listing' != $post->post_type && get_current_user_id() != $post->post_author ){
			?>
		...
		<?php if ( $the_query->have_posts() ){
			...
			<div class="wpjms-chart-legend">
				...
				<div class="wpjms-legend-search-wrap">
					<input autocomplete="off" type="search" id="wpjms-legend-search" placeholder="<?php echo esc_attr( 'Search listings...', 'wp-job-manager-stats' );?>"/>
				</div>
...
<?php
	...
	public function scripts(){
		...
		/* CSS */
		wp_register_style( 'wpjms-dashboard', WPJMS_URL . 'assets/dashboard/dashboard.css' , array( 'dashicons', 'date-range-picker', 'jquery-ui' ), WPJMS_VERSION );
		...
		/* JS */
		wp_register_script( 'wpjms-dashboard', WPJMS_URL . 'assets/dashboard/dashboard.js', array( 'jquery', 'blockUI', 'moment-js', 'date-range-picker', 'chart-js', 'jquery-ui-autocomplete' ), WPJMS_VERSION, true );
		...
		/* JS */
		wp_register_script( 'wpjms-dashboard-job-stats', WPJMS_URL . 'assets/dashboard/dashboard-job-stats.js', array( 'jquery', 'blockUI', 'moment-js', 'date-range-picker', 'chart-js' ), WPJMS_VERSION, true );
