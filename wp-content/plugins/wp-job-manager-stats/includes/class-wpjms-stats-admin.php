...
class WPJMS_Stats_Admin{
	...
	public function admin_scripts( $hook_suffix ){
		...
		if ( 'edit.php' == $hook_suffix && 'job_listing' == $post_type ){
			...
			/* CSS */
			wp_enqueue_style( 'wpjms-admin', WPJMS_URL . 'assets/admin/admin.css', array( 'date-range-picker' ), WPJMS_VERSION );

			/* JS */
			wp_enqueue_script( 'wpjms-admin', WPJMS_URL . 'assets/admin/admin.js', array( 'jquery', 'blockUI', 'moment-js', 'date-range-picker', 'chart-js' ), WPJMS_VERSION, true );
			$ajax_data = array(
