	...
	function meta_keys(){
		...
		return apply_filters( 'job_manager_field_editor_js_conf_meta_keys', array(
				...
				"job_title"            => array(
					...
					"disable_field_notice" => __( 'This field is required by the core WP Job Manager plugin and can not be disabled.', 'wp-job-manager-field-editor' )
				),
				"job_location" => array(
					"disable_types" => array(
						'wp-editor',
		...
		return apply_filters( 'job_manager_field_editor_js_conf_checkbox', array(
				"checked"   => array(
					"output_enable_fw"  => array(
						"show" => array('output_full_wrap'),
						"hide" => array()
					),
					"output_enable_vw"  => array(
						"show" => array('output_value_wrap')
					),
					"output_show_label" => array(
						"show" => array('output_label_wrap')
					),
					"multiple" => array(
				...
				"unchecked" => array(
					"output_enable_fw"  => array(
						"hide" => array('output_full_wrap')
					),
					"output_enable_vw"  => array(
						"hide" => array('output_value_wrap')
					),
					"output_show_label" => array(
						"hide" => array('output_label_wrap')
					),
					"multiple" => array(
