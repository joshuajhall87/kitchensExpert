...
class WP_Job_Manager_Field_Editor_Job_Writepanels {

	private static $instance;
	public static $wp_editors;

	function __construct() {
		add_action( 'job_manager_input_wp_editor', array( $this, 'wp_editor' ), 10, 2 );
	}
	 ...
	 * @since 1.4.0
	 *
	 * @return WP_Job_Manager_Field_Editor_Job_Writepanels
	 */
