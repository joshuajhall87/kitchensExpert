...
class sMyles_Updater_v2 {
	...
	public function init_updates( $file ) {
		...
		include_once('smyles-updater-api.php');
		include_once('smyles-updater-key-api.php');
		include_once('smyles-updater-licenses.php');
	...
	public function admin_init() {
		...
		if( empty($this->instance_id) ) {
			...
			if( ! class_exists( 'sMyles_Updater_Password_Management' ) ) {
				include_once('smyles-updater-passwords.php');
			}
